...
python: 3.9.3
django 3.2
0. vào project mở file beautyshop->settings.py->dòng 84 đến 86 sửa theo máy của mình, hoặc cấu hình theo vậy luôn cho đồng bộ. dòng 14, 146 là email của shop để gửi mail cho các tài khoản
1. mở terminal lên 
